...
class SliderController extends Controller
{
    ...
    public function storeSlider(Request $request){
        ...
        if ($request->hasFile('slider_photo')) {
            ...
            Image::make($uploaded_photo)->resize(1920,1280)->save(base_path($new_photo_location));
    ...
    public function updateSlider(Request $request, $id){
        ...
        if ($request->hasFile('slider_photo')) {
            ...
            Image::make($request->file('slider_photo'))->resize(1920, 1280)->save(base_path('public/dashbord/image/slider_image/' . $file_name));
            Slider::find($id)->update([
